...
<head>
  ...
  <title>Act! has helped put Morningside Employments specialists to work</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 txtcenter col-sm-push-2">
        <p class="lead">When a team of not-for-profit employment mentors needed to securely and more effectively manage a wealth of data - including highly sensitive client information - it was Act! they trusted to improve both productivity and preserve client confidentiality.</p>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row  ">
      ...
      <div class="col-sm-6 col-sm-push-1 ">
        ...
        <blockquote class="plainquote-test">"Act! gives us the information we need quickly and accurately, which means we can focus more time and effort on supporting clients. And over the eight years we've been using it, the software's continually developed, so we know that in the future it will keep pace with our needs as we grow and evolve."
          <br>
          <cite>Jim Larson
    ...
    <div class="container">
      <div class="row ">
        ...
        <div class="col-sm-6 col-sm-push-1">
          <div>
            <h2>Results</h2>
            <p class="lead">Time saved on invoicing - <span class="orangetitle">one week per month</span> for each programme manager.
            </p>
            <p class="lead">Morningside is now able to support <span class="orangetitle">over 700 clients return to work each year</span> because it can quickly access <span class="orangetitle">up-to-the-minute information</span> about their needs and those of potential employers.
            </p>
            <p class="lead"><span class="orangetitle">68 field staff and managers have access to a centralised database</span> of client and business information, fast-tracking client assessments and employment opportunities and <span class="orangetitle">reducing response time</span> should issues arise.
            </p>
          </div>
        </div>
      </div>
