...
<head>
        ...
        <title>Kontakt zum Act! Team per Telefon, E-Mail oder Kontaktformular</title>
        <meta name="description" content="Ob Fragen zu unserem Act! Produkt, Anregungen, Lob oder Kritik - rufen Sie uns an oder Schreiben Sie uns! So erreichen Sie uns:">
		...
		<link rel="canonical" href="http://www.act.com/de-de/kontakt/" />
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["deContact"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
    ...
    <div class="container">
    	<div class="row section">
    	  	<div class="col-sm-8 col-sm-push-2 txtcenter">
    	  	  		<div class="row">
    	  	  	  		<h1 class="large_strapline">Kontakt</h1>
		  	  			<p class="strapline_intro">Ob Fragen zu unserem Produkt, Anregungen, Lob oder Kritik – füllen Sie einfach das Kontaktformular aus und wir kommen schnellstmöglich auf Sie zurück. Selbstverständlich beantworten wir Ihre Anfragen auch gerne telefonisch.</p>
		  	  		</div>
		  	  </div>
    	</div>
	</div>
    ...
    <div class="container">
	    <div class="row">
        	<div class="col-sm-6 contact-triangle " >
            	<h2 class="txtcenter">So erreichen Sie uns:</h2>
            	<table class="contact-table">
          <tr><td><strong>Deutschland:</strong></td><td> 069 643 508 433</td></tr>
					<tr><td><strong>Schweiz:</strong> </td><td> 043 508 2364</td></tr>
          <tr><td><strong>DACH Support:</strong></td><td><a href="mailto:support-deutsch@swiftpage.com">support-deutsch@swiftpage.com</a></td></tr>
          <tr><td><strong>Vertrieb:</strong></td><td><a href="mailto:vertrieb@swiftpage.com">vertrieb@swiftpage.com</a></td></tr>
          <tr><td><strong>DACH Business Partners:</strong></td><td><a href="mailto:business-partner-dach@swiftpage.com">business-partner-dach@swiftpage.com</a></td></tr>
           ...
           <br><br><br>
            	...
            	<h2 class="txtcenter">Geschäftszeiten</h2>
            	<ul class="floated-list ">
            		<li><strong>Montag:</strong> 9 Uhr - 17 Uhr</li>
					<li><strong>Dienstag:</strong> 9 Uhr - 17 Uhr</li>
					<li><strong>Mittwoch:</strong> 9 Uhr - 17 Uhr</li>
					<li><strong>Donnerstag:</strong> 9 Uhr - 17 Uhr</li>
					<li><strong>Freitag:</strong> 9 Uhr - 17 Uhr</li>
        ...
        <div class="col-sm-6 contact-form">
			<div class="col-md-10 col-md-push-2">
            	<h2 class="txtcenter">Schreiben Sie uns</h2>

					<!-- BEGIN FORM -->
<!--<form action="https://www.msgapp.com/RESTForm.aspx" method="GET">-->
<form name="deContact" action="https://s1966950654.t.eloqua.com/e/f2" method="POST" id="form96">
                
<input type="hidden" name="elqFormName" value="deContact">
<input type="hidden" name="elqSiteID" value="1966950654">
<input type="hidden" name="LeadSource" value="LCRMAA0000OD">
...
<div id="formElement9"><input  class="btn btn-primary" type="submit" value="Abschicken" onClick="ga('send', 'event', 'DE Contact', 'send-message', 'send-message');track_load('http://www.act.com/de-de/kontakt/', 'Contact Submit Button (de)')"/></div>
...
<script type="text/javascript" >
	var Prefix = new LiveValidation("prefix1", {valid: "", onlyOnBlur: true});Prefix.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});var FirstName = new LiveValidation("FirstName", {valid: "", onlyOnBlur: true});FirstName.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});var LastName = new LiveValidation("LastName", {valid: "", onlyOnBlur: true});LastName.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});var Company = new LiveValidation("Company", {valid: "", onlyOnBlur: true});Company.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});var busPhone = new LiveValidation("busPhone", {valid: "", onlyOnBlur: true});busPhone.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});var country = new LiveValidation("country", {valid: "", onlyOnBlur: true});country.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});var emailAddress = new LiveValidation("emailAddress", {validNotes: "", onlyOnBlur: true});emailAddress.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});emailAddress.add(Validate.Format, {pattern: /^[ ]*([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})[ ]*$/i, failureMessage: "Eine gültige e-Mail-Adresse ist erforderlich"});var notesMostRecent1 = new LiveValidation("notesMostRecent1", {valid: "", onlyOnBlur: true});notesMostRecent1.add(Validate.Presence, {failureMessage:"Dieses Feld ist erforderlich."});
