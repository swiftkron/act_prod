...
<div class="grey-bg slider-height">
          <div class="container">
              <div class="row section">
                  ...
                  <a href="partners-map" title="Find a local partner to help get you up and running effectively and keep you running smoothly" class="btn-primary btn">find partner</a> <a href="test-drive" title="Online access to Act! desktop software through your web browser" class="btn-second btn">free trial</a> <a href="demo" title="Request a demonstration of Act!" class="btn-second btn">request demo</a>
                </div>
              </div>
    ...
    <div class="container">
        ...
        <div class="row mobile-center orange-three" >
          <!--ITEM-->
            <div class="col-sm-4">
                <div class="col-sm-4">
                  <img src="/en-uk/img/icon-group.png" alt="">
                </div>
        <div class="col-sm-8 padding-bottom">
          ...
          <!--ITEM-->
            <div class="col-sm-4">
                <div class="col-sm-4">
                  <img src="/en-uk/img/icon-organised.png" alt="">
                </div>
        <div class="col-sm-8 padding-bottom">
          ...
          <!--ITEM-->
            <div class="col-sm-4">
                <div class="col-sm-4">
                  <img src="/en-uk/img/icon-integrate.png" alt="">
                </div>
          <div class="col-sm-8">
