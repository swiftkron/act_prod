...
<head>
        ...
        <title>Act! Support - Contact</title>
        ...
        <link rel="canonical" href="http://www.act.com/en-uk/support/contact/" />
...
<input type="hidden" name="PreferredLanguage" value="English (International)" /> 
<p class="smalltext"><span class="required">*</span> denotes a required field</p>

<div class="row">
<div class="col-md-6">
  <div class="label"><label for="FirstName">First Name <span class="required">*</span></label></div>
  <div class="field"><input id="firstname" type="text" name="FirstName" /></div>
  <div class="label"><label for="LastName">Last Name <span class="required">*</span></label></div>
  <div class="field"><input id="lastname" type="text" name="LastName" /></div>
  <div class="label"><label for="PhoneNumber">Phone Number <span class="required">*</span></label></div>
  <div class="field"><input id="phone" type="text" name="PhoneNumber" maxlength="18" /></div>
  <div class="label"><label for="EmailAddress">Email Address <span class="required">*</span></label></div>
  <div class="field"><input id="emailaddress" type="text" name="EmailAddress" /></div>
<div class="label"><label for="Country">Country <span class="required">*</span></label></div>
<div class="field">
...
<div class="col-md-6">
                    ...
                    <div class="label"><label for="Product">Product <span class="required">*</span></label></div>
                    ...
                    <div class="label"><label for="Description">Ticket Description <span class="required">*</span></label></div>
                    <div class="field"><textarea name="Description" id="description"></textarea></div>
                    <div class="label"><label for="AccountNumber">Account Number <span class="hint">examples: 411XXXXXX, 400XXXXXX, XXXXXXXX-ACT, AXXXXXXXX</span></label></div>
...
<input type="submit" value="Submit Ticket" class="btn-primary btn" /> 
</form>
</div>
