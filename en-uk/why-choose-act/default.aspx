...
<!-- #Include File="/en-uk/includes/header.inc" -->
      ...
      <div class="section-bg mb-bg-right toppadding" id="whypagefix" style=" background-image:url('/en-uk/img/bg-why-choose-act-crm.jpg')">
                <div class="container">
...
<!--END SECOND NAV BAR-->
          	...
          	<div class="row ">
            	...
            	<div class="col-sm-8 "> 
			  	...
			  	<div class="col-sm-3 col-sm-push-1 mb-center">
					<p><img src="/en-uk/img/get-together.png" alt="" /></p>
				</div>
			</div>
			</div>
          <!-- END ROW --> 
      ...
      <div class="section-bg mb-bg-left" id="marketing-selling" style="min-height:530px;background-image:url('/en-uk/img/bg-marketing-sales-act-contact-management.jpg')">
        <div class="container">
          	<div class="row">
        ...
        <div class="container " id="still-the-one">
          	<div class="row">
            	...
            	<div class="col-sm-8  "> 
			  	...
			  	<div class="col-sm-3 col-sm-push-1 mb-center ">
					<p><img src="/en-uk/img/trusted.png" alt=""  /></p>
				</div>
			</div>
			</div>
          <!-- END ROW --> 
