...
<head>
        ...
        <title>Welche Erfahrungen haben andere Unternehmen mit Act! gemacht?</title>
        <meta name="description" content="In welcher Branche Sie auch tätig sind - mit der CRM Software Act! finden wir die richtige Lösung für Ihr Unternehmen! Lesen Sie die Berichte unserer Kunden.">
...
<div class="cleafix"></div>
	...
	<div class="container">
          ...
          <div class="col-sm-12 txtcenter">
            <h1 class="large_strapline">Kundenreferenzen</h1>
          </div>
        </div>
        <div class="row">
          	<div class="col-sm-8 col-sm-offset-2 txtcenter">
            	<p class="lead notopmargin">Welche Erfahrungen haben andere Kunden mit uns gemacht? In welcher Branche Sie auch tätig sind - wir haben die richtige Lösung für Ihr Unternehmen! Lesen Sie die Berichte unserer Kunden.</p>
			</div>
        </div><!--ROW END-->
    </div>
...
<!--SECOND NAV BAR-->
    <div id="scroller-anchor"  >
	  	<div id="testimonial-navigation" >
            ...
            <div class="row">
              <div class="col-sm-12">
	    		  	<li><strong>Ergebnisse filtern nach:</strong></li>
