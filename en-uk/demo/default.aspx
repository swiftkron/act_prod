...
<head>
        ...
        <title>Spend Some Time With an Act! Product Expert</title>
        <meta name="description" content="Request a demonstration and one of our experts will arrange a quick 1-2-1 session to demonstrate how Act! can transform your business.">
		...
		<link rel="canonical" href="http://www.act.com/en-uk/demo/" />
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["ukDemo"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
    ...
    <div class="container">
    	<div class="row section">
    	  	<div class="col-sm-8 col-sm-push-2 txtcenter">
    	  	  		<div class="row">
    	  	  	  		<h1 class="large_strapline">Request a demonstration</h1>
		  	  			<p class="strapline_intro">If you would like one of our sales reps to talk you through how Act! can transform your business, fill in the form and we will contact you shortly.</p>
		  	  		</div>
		  	  </div>
    	</div>
	</div>
	    ...
	    <div class="row tabledisplay">
            ...
            <div class="row">
              <div class="col-sm-10">
                ...
                <p class="lead">Trusted by individuals, small businesses, and sales teams. Get organised, take the guesswork out of marketing to drive sales results and then simply contact us once your trial is complete. Complete the form to begin your trial.</p>
				<p class="lead orangetitle">2.8 million users trust Act! to help run their business.</p>
      </div>
    </div>
        <div class="relative  demo-fix">	<img src="/en-uk/img/demonstration-of-act-crm.png" class="demo" />  </div>
			</div>

        <div class="col-sm-6 contact-form tablecell">
			<div class="col-md-10 col-md-push-2">
            	<h2 class="txtcenter">Request a demo</h2>
 	            			<asp:Label runat="server" id="ContactFormOutput"></asp:Label>

<form name="ukDemo" action="https://s1966950654.t.eloqua.com/e/f2" method="POST" id="form82">
                
<input type="hidden" name="elqFormName" value="ukDemo">
...
<input type=hidden name="rurl" value="http://www.act.com/en-uk/demo/default.aspx?thankyou">
...
<div id="formElement9" >
	<input type="submit" value="Send" class="btn btn-primary" onClick="ga('send', 'event', 'UK Demo', 'demonstration-request', 'send');track_load('http://www.act.com/en-uk/demo/', 'Demo Submit Button (en)')"  />
</div>
...
<!-- end FORM -->
    ...
    <div class="container">
        <div class="row">
            ...
            <img src="/en-uk/img/limefresh.jpg" /> <img src="/en-uk/img/mcj.jpg" /> <img src="/en-uk/img/reebok.jpg" />
            </div>
        </div>
    </div>
        ...
        function setValues1() {
          ...
          if (state == true) { document.getElementById('doNotEmail1').value = "0";
           ...
           document.getElementById('optIn1').value = "Y"; }
	        ...
	        var thankYouMessage = '<p><strong  class="orangetitle">Thank You</strong>.</p><p>Your request has been sent.</p><p>We will do our best to answer your query within one business day. </p>';
