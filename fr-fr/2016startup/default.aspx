    ...
    <div class="container">
        ...
        <li id="whatsnew" class="slide">
            <div class="slideDiv">
              ...
              <div style="text-align: center;"><a href="http://www.act.com/fr-fr/produits/nouveautes" target="_blank"><button>En savoir plus</button></a></div>
            </div>
          </li>
          <li id="aem" class="slide">
            <div class="slideDiv">
              ...
              <a href="http://www.act.com/fr-fr/produits/act-emarketing" target="_blank"><button>En savoir plus</button></a>
            </div>
          </li>
        </ul>  
        <div id="controls">
