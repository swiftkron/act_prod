...
<head>
        ...
        <title>Demande de démo - Act! gestion des contacts</title>
        <meta name="description" content="Démonstration personnalisée du logiciel de gestion des contacts Act! par un consultant CRM. Demander une démo aujourd'hui">
		...
		<link rel="canonical" href="http://www.act.com/fr-fr/demo/" />
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["frDemo"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
    ...
    <div class="container">
    	<div class="row section">
    	  	<div class="col-sm-12 txtcenter">
    	  	  		<div class="row">
    	  	  	  		<h1 class="large_strapline">Démonstration personnalisée</h1>
		  	  			<p class="strapline_intro">Si vous souhaitez que l'un de nos consultants CRM vous présente comment Act! peut transformer votre entreprise, veuillez remplir le formulaire ci-dessous et nous vous rappelerons dans les plus brefs délais.</p>
		  	  		</div>
		  	  </div>
    	</div>
	</div>
	    ...
	    <div class="row tabledisplay">
            ...
            <div class="row">
              <div class="col-sm-10">
                ...
                <p class="lead">Utilisé avec confiance par les auto-entrepreneurs, les petites entreprises et les équipes commerciales du monde entier, Act! vous permet de vous organiser de manière pertinente et de mener des campagnes marketing adaptées qui vous aideront à réaliser des ventes et à faire prospérer votre entreprise.</p>
				<p class="lead orangetitle">2,8 millions d'utilisateurs convaincus</p>
      </div>
    </div>
        <div class="relative  demo-fix">	<img src="img/apercu-demo-logiciel-crm.png" class="demo" alt="Aperçu de la démo de notre logiciel CRM" />  </div>
			</div>

        <div class="col-sm-6 contact-form tablecell">
			<div class="col-md-10 col-md-push-2">
            	<h2 class="txtcenter">Demande de démonstration</h2>
 	            			<asp:Label runat="server" id="ContactFormOutput"></asp:Label>
<form name="frDemo" action="https://s1966950654.t.eloqua.com/e/f2" method="POST" id="form91">
                
<input type="hidden" name="elqFormName" value="frDemo">
...
<div id="formElementX" class="formRow"><span id="reqOptIn"><input  id="check1" type="checkbox" checked="check" onchange="setValues1();" />Oui, merci de m’envoyer des emails concernant Act!</span></div>

<div id="formElement9" >
	<input type="submit" value="Envoyer" class="btn btn-primary" onClick="ga('send', 'event', 'FR Demo', 'demonstration-request', 'send');track_load('http://www.act.com/fr-fr/demo/', 'Demo Submit Button (fr)')"/>
</div>
