...
<head>
        ...
        <title>Assistance Act! - Contact</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />

        <!-- HREF LANG TAG -->
<link rel="alternate" hreflang="en" href="http://www.act.com/en-uk/support/contact/" />
<link rel="alternate" hreflang="en-us" href="http://www.act.com/support/contact/" />
<link rel="alternate" hreflang="fr" href="http://www.act.com/fr-fr/assistance/contact/" />
<link rel="alternate" hreflang="de" href="http://www.act.com/de-de/support/kontakt/" />
<link rel="canonical" href="http://www.act.com/fr-fr/assistance/contact/" />
        <link rel="stylesheet" href="css/normalize.min.css">
        <link rel="stylesheet" href="css/app.css">

     <link rel="stylesheet" href="/css/intlSupportTicket.css">
...
<h2>Soumettre un ticket d'assistance</h2>
<form id="ticketForm" action="javascript:return;">
<input type="hidden" name="PreferredLanguage" value="French (France)" /> 
<p class="smalltext"><span class="required">*</span> indique un champ obligatoire</p>

<div class="row">
<div class="col-md-6">
  <!-- <div class="label"><label for="Title">Titre</label></div>
  <div class="field"><select id="title" name="Title">
        <option value="M">M</option>
        <option value="Mme">Mme</option>
        <option value="Mlle">Mlle</option>
      </select></div> -->
  <div class="label"><label for="FirstName">Pr&eacute;nom <span class="required">*</span></label></div>
  <div class="field"><input id="firstname" type="text" name="FirstName" /></div>
  <div class="label"><label for="LastName">Nom <span class="required">*</span></label></div>
  <div class="field"><input id="lastname" type="text" name="LastName" /></div>
  <div class="label"><label for="PhoneNumber">T&eacute;l&eacute;phone <span class="required">*</span></label></div>
  <div class="field"><input id="phone" type="text" name="PhoneNumber" maxlength="18" /></div>
  <div class="label"><label for="EmailAddress">Email <span class="required">*</span></label></div>
  <div class="field"><input id="emailaddress" type="text" name="EmailAddress" /></div>
<div class="label"><label for="Country">Pays <span class="required">*</span></label></div>
<div class="field">
                    ...
                    <div class="label"><label for="PostalCode">Code postal</label></div>
                    <div class="field"><input id="postalcode" type="text" name="PostalCode" /></div>
...
<div class="col-md-6">
                    ...
                    <div class="label"><label for="AccountNumber">Num&eacute;ro client <span class="hint">411XXXXXX, 400XXXXXX, XXXXXXXX-ACT, AXXXXXXXX</span></label></div>
                    <div class="field"><input id="accountnumber" type="text" name="AccountNumber" /></div>
                    <div class="label"><label for="CompanyName">Soci&eacute;t&eacute;</label></div>
                    <div class="field"><input id="company" type="text" name="CompanyName" /></div>
  
</div>
</div>
 
<input type="submit" value="Soumettre le ticket" class="btn-primary btn" /> 
</form>
</div>
