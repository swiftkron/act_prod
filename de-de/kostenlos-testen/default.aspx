...
<head>
        ...
        <title>Den Act! Kontakt- & Kundenmanager jetzt 30 Tage kostenlos testen</title>
        <meta name="description" content="Testen Sie 30 Tage lang eine der beliebtesten und meistverkauften Kontakt- und Kundenmanagement Softwares.">
		...
		<link rel="canonical" href="http://www.act.com/de-de/kostenlos-testen/" />
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["deDownlTrial"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
...
<body id="trial_page">
        ...
        <div class="container">
          <div class="row section">
            <div class="col-sm-10 col-sm-push-1 txtcenter">
              <div class="row">
                <h1 class="large_strapline">30 Tage kostenlos testen</h1>
                <p class="strapline_intro">
                 Registrieren Sie sich jetzt und testen Sie 30 Tage lang eine der beliebtesten und meistverkauften Kontakt- und Kundenmanagement Softwares.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row tabledisplay">
            <div class="col-sm-6 contact-triangle tablecell" >
              ...
              <p class="lead">
                Ob Einzelunternehmen, Kleinunternehmen oder Verkaufsteam im Mittelstand: Act! unterstützt Sie bei zielgerichteten Marketingkampagnen und beim Managen Ihrer Geschäftsbeziehungen. Geben Sie Ihre Daten in das Kontaktformular ein und beginnen Sie Ihre Testversion.
              </p>
              <p class="lead orangetitle">2,8 Mio. Nutzer vertrauen bereits Act! und gestalten ihre Geschäftsabläufe jetzt noch effektiver.</p>

              </div>
              <div class="relative col-sm-12 trial-fix">
              <img src="img/zugriff-kontakte-tablet-smartphone.png" alt="Auf Kontakte via Tablet und Smartphone zugreifen" class="trial-tablet" />
            </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 contact-form tablecell">
              <div class="col-md-10 col-md-push-2">
                <h2 class="txtcenter">Jetzt testen</h2>

             <form name="deDownlTrial" action="https://s1966950654.t.eloqua.com/e/f2" method="POST" id="form98">
                
                <input type="hidden" name="elqFormName" value="deDownlTrial">
                <input type="hidden" name="elqSiteID" value="1966950654">
                <input type="hidden" name="LeadSource" value="LCRMAA0000OC">
                ...
                <input type="hidden" name="doNotEmail1" id="doNotEmail1" value="0">
                  ...
                  <div id="formElement4"  class="formRow">
                    <label for="busPhone">Telefon*</label>
                    <input class="text_input" id="busPhone" name="busPhone" type="text" value=""  />
                  </div>

                  <div id="formElement5"  class="formRow">
                    <label for="country">Land</label>
                    <select id="country" name="country" class="select_input chosen-select form-control" onChange="countryOptin(this.form);" onLoad="countryOptin(this.form);">
            ...
            <option value="United States">United States</option>
                  ...
                  <div id="formElementX" class="formRow">
                    <span id="reqOptIn">
                     ...
                     Ich bin damit einverstanden, dass ein Act! Mitarbeiter mich kontaktiert, damit ich bestm&ouml;gliche Unterst&uuml;tzung zur CRM Software und hilfreiche Informationen zu Act! erhalten kann. 
                    </span>
                  </div>

                  <input type="submit" class="btn btn-primary" value="Abschicken" onClick="ga('send', 'event', 'DE Demo', 'form-complete', 'trial-download');track_load('http://www.act.com/de-de/kostenios-testen/', 'Test Drive Submit Button (de)')"/>
      ...
      function countryOptin(thisForm) {
        ...
        <script>
          var thankYouMessage = '<h2 class="lead orangetitle">Testen Sie Act! jetzt 30 Tage kostenlos</h2><a class="btn btn-primary" href="http://cdn.act.dlm.swiftpage.com/3859/act_prem_171x51_de.exe" onClick="ga("send", "event", "DE Demo", "pop-up", "download-now");"><strong class="buynow">Zum Download</strong></a><p><b>Bitte setzen Sie sich mit uns in Verbindung, sollten Sie Fragen haben oder nähere Informationen zu Act! benötigen.</b></p><p><b>Deutschland:</b> 069 643 508 433<br /><b>Schweiz:</b> 043 508 2364 <br /><b>Vertrieb E-Mail:</b> <a href="mailto:vertrieb@swiftpage.com" onClick="ga("send", "event", "DE Demo", "pop-up", "vertrieb@swiftpage.com");">vertrieb@swiftpage.com</a></p><p><a href="produkte/Systemvoraussetzungen" target="_blank">Act! Systemvoraussetzungen</a></p><p><b>Wichtiger Hinweis:</b><br />Sie testen die Act! Version v17. Sollten Sie eine ältere Version von Act! bereits aktiv nutzen, stellen Sie bitte sicher, dass Sie die Act! Testversion und die Version von Act!, die Sie momentan benutzen, nicht auf demselben Rechner installieren.</p>';
          ...
          var requiredMessage = '<div class="highlighted_error">*Dieses Feld ist erforderlich</div>';
