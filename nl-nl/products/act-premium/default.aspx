...
<head>
        ...
        <title>Act! Premium - Mobile Customer Relationship Management (CRM)</title>
        <meta name="description" content="Act! gives you a view of customer contact data, emails, meetings, activities, and history. Interacts with Microsoft Outlook, Google, LinkedIn and more.">
...
<div class="grey-bg slider-height">
          <div class="container">
              <div class="row section">
                  ...
                  <a href="partners-map" title="Find a local partner to help get you up and running effectively and keep you running smoothly" class="btn-primary btn">find partner</a><a href="demo" title="Request a demonstration of Act!" class="btn-second btn">request demo</a>
                </div>
              </div>
              <div class="col-sm-4  col-sm-push-1 mb-center">
                  <img src="/nl-nl/img/act-premium-box-shot.png" alt="Box of Act! CRM Premium" />
              </div>
              </div>
          </div>
</div>
...
<div class="cleafix"></div>
    ...
    <div class="container">
        ...
        <div class="col-sm-8 padding-bottom">
            ...
            Designed for individuals and teams of up to 10 or more users.
                </div>
            </div>
          <!--ITEM END-->
          <!--ITEM-->
    ...
    <div class=" grey-bg section-bg nopad" id="Actpermiummobile" style="min-height:530px;">
         <div class="container">
          <div class="row ">
              <div class="col-sm-6">
                <img src="/nl-nl/img/ipad-and-iphone-running-act-crm.png" alt="Laptop using Act! showing details of contact data" class="negative-left" />
              </div>
          <div class="col-sm-6">
    ...
    <div class="container" id="Customerscontacts">
        <div class="row   section-padding">
          <div class="col-sm-6 ">
            ...
            <img style="max-width:100%;position:relative; margin-left:-40px;" src="/nl-nl/img/act-crm-timeline-screenshot.jpg" alt="Screenshot of graphical representation of database timeline" />
   ...
   <li><span> Benefit from team-based features like group dashboards and reports, team calendar view, and enhanced security settings. </span></li>
          ...
          <!-- ROW (text right, image left) -->
  <div class="section-bg section-padding" id="Sendemails" style="min-height:530px;background-image:url('/nl-nl/img/working-from-coffee-shop-with-act.jpg')">
        <div class="container">
            <div class="row ">
         ...
         <div class="container" id="Measureresults">
          ...
          <div class="col-sm-6 col-sm-push-6">
            <img src="/nl-nl/img/act-crm-linkedin-integration-screenshot.jpg" alt="Screenshot of Act! CRM contact view of LinkedIn integration" />
        </div>
...
<div class="grey-bg nopad">
        <div class="container" id="generateabuzz">
          <div class="row ">
            <div class="col-sm-6 ">
              <img src="/nl-nl/img/laptop-using-act-with-integration-and-data-source.png" alt="Laptop showing integrations and data source with Act!" class="negative-left"></div>
