...
<head>
        ...
        <title>Act! Support - Kontakt</title>
        ...
        <link rel="canonical" href="http://www.act.com/de-de/support/kontakt/" />
...
<div class="row">
<div class="col-md-6">
  <!-- <div class="label"><label for="Title">Anrede</label></div>
  <div class="field"><select id="title" name="Title">
        <option value="Herr">Herr</option>
        <option value="Frau">Frau</option>
      </select></div> -->
  <div class="label"><label for="FirstName">Vorname <span class="required">*</span></label></div>
  <div class="field"><input id="firstname" type="text" name="FirstName" /></div>
  <div class="label"><label for="LastName">Nachname <span class="required">*</span></label></div>
  <div class="field"><input id="lastname" type="text" name="LastName" /></div>
  <div class="label"><label for="PhoneNumber">Telefon <span class="required">*</span></label></div>
  <div class="field"><input id="phone" type="text" name="PhoneNumber" maxlength="18" /></div>
  <div class="label"><label for="EmailAddress">E-Mail <span class="required">*</span></label></div>
  <div class="field"><input id="emailaddress" type="text" name="EmailAddress" /></div>
<div class="label"><label for="Country">Land <span class="required">*</span></label></div>
<div class="field">
                    ...
                    <div class="label"><label for="PostalCode">Postleitzahl</label></div>
...
<div class="col-md-6">
                    ...
                    <div class="label"><label for="Description">Beschreibung (Bitte beschreiben Sie das Problem so genau wie m&ouml;glich.) <span class="required">*</span></label></div>
...
<input type="submit" value="Ticket abschicken" class="btn-primary btn" /> 
</form>
</div>
